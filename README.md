...
- Lo mismo pasa al **iniciar un servicio nuevo** (que arranca en la etapa "Recibido") o si se regresa manualmente a esa etapa: aparece la misma ventana de WhatsApp, pero con un mensaje distinto avisando que el vehículo fue recibido, junto con el enlace directo a su ficha pública (`https://blaze151.github.io/TEAM-BASSOCO/?v=ID_DEL_VEHÍCULO`) para que el cliente pueda checar el avance cuando quiera.
